...
mkdir -p /ssd_scratch/cvit/piyush/${subtype}/

mkdir -p ./${subtype}_hyper_para_tuning/


# rsync -zaPq ecdp2020@10.4.16.73:TCGA/${subtype}/ /ssd_scratch/cvit/piyush/${subtype}/SLIDES/
rsync -zaPq ecdp2020@10.4.16.73:TCGA_PATCHES/${subtype}/ /ssd_scratch/cvit/piyush/${subtype}/

# python extract_patches.py \
#   --root_dir /ssd_scratch/cvit/piyush/${subtype}/SLIDES/ \
#   --dest_dir /ssd_scratch/cvit/piyush/${subtype}/PATCHES/ \
#   --extras_dir /ssd_scratch/cvit/piyush/${subtype}/EXTRAS/  | tee ./${subtype}/log_patch.txt
