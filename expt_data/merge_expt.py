        ...
        for type in ["cancer", "normal"]:
            for slide_id, patches in expt_dict[split][type].items():
                for patch in patches:
                    src = os.path.join(root_expt, type, slide_id, patch)
                    dest = os.path.join(root_original, type, slide_id, patch)
...
#         --expt_val_dir /ssd_scratch/cvit/piyush/LIHC/val_data_expt \
